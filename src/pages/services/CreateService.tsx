...
const CreateServiceForm: React.FC = () => {
  ...
  return (
    <div className="form-container">
      <Toaster/>
      <h1 className="text-3xl text-center font-bold underline py-4">
        Create Service
      </h1>
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        {/* Submit Button */}
        <button type="submit" className='text-center bg-lime-500 text-white px-4 py-2 rounded-md center '>Submit</button>
      </form>
    </div>
  );
};
